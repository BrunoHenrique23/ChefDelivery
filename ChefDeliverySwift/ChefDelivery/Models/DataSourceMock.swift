...
let paymentTypesMocks: [PaymentType] = [
    PaymentType(id: 1, name: "Crédito/Débito",imageUrl: "mastercard"),
    PaymentType(id: 2, name: "Pix",imageUrl: "pix"),
    PaymentType(id: 3, name: "Apple pay",imageUrl: "apple-pay"),
    PaymentType(id: 4, name: "Nubank",imageUrl: "nubank"),
    PaymentType(id: 5, name: "Pluxe Refeição",imageUrl: "pluxee")
]
